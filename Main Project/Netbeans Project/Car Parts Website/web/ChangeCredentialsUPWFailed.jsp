<%-- 
    Document   : ChangeCredentialsUPWFailed
    Created on : Nov 15, 2025, 4:56:20 PM
    Author     : Grant
--%>
...
<!--   HERO SECTION (not needed for account page)
  ...
  <!-- Account form -->
    <main>
      <form class="account-card" onsubmit="return validatePasswords()" action="ChangeUsernameServlet" method="post">
        <!--Update message-->
        <div class="update-label">Username/password combination failed.</div>
        <h2>Change Username/Password</h2>
                    ...
                    <label for="newUsername">New Username(required to change username)</label>
                    <input type="text" class="form-input" placeholder="Enter your new username" name ="newUsername" id="newUsername"/>
                    
                    <div id="error-message" style="color: red; font-size: 18px; text-align: right; display: none;">
                      ERROR: Passwords must match.
                    </div>

                    <button type="button" class="logout-btn" style="background-color: #000;" onclick="window.location.href='AccountServlet'">
                        Change other account info
                    </button>
                    <button type="submit" class="logout-btn">
                        Change Username
                    </button>
                    
                    <button type="submit" class="logout-btn" formaction="ChangePasswordServlet">
                        Change Password
                    </button>
