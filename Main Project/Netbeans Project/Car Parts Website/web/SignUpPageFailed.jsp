<%-- 
    Document   : SignUpPageFailed
    Created on : Nov 6, 2025, 12:00:45 AM
    Author     : Grant
--%>
...
<body>
    <div class="container">
          <div class="card" role="main" aria-label="Login card">
              ...
              <form onsubmit="return validatePasswords()" action="CreateAccountServlet" method="post">
                    ...
                    <div id="duplicate-error" style="color: red; font-size: 18px; text-align: right; margin-bottom: 10px; display: block;">
                        ERROR: Username and/or email already in use.
                    </div>
    ...
    <script>
      ...
      // Hide duplicate error when any input is clicked
